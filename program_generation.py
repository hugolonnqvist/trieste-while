...
def gen_partial_random_program(max_loc):
    ...
    TEMPLATE_BLOCKS = [
        ...
        "x := 2 + 3; y := x + 1; output y;",

        # Constant folding with nested expressions
        "a := 10; b := a + 0; c := b * 1; output c;",
    ...
    main_stmt = "var x; var y; var z; var a; var b; var c;\n"
